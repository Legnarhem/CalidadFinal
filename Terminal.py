...
"""
    ...
    def __subMenuAlumnosAsignatura(self, asignatura):
        if asignatura is not None:
            ...
            i = 0
            opc = -1
            misAlumnos = self.getAlumnoController().obtener_alus_asignatura(asignatura.getCodigo(), self.getSesion())
            if len(misAlumnos) > 0:
                print " Elija alumno:"
    ...
    def __subMenuMediaAlumnoAsignatura(self, alumno, asignatura):
        if alumno is not None:
            self.__clear()
            media = self.getAlumnoController().obtener_media(alumno.getDNI(), asignatura.getCodigo(), self.getSesion())
    ...
    def __subMenuMediaAlumnoCentro(self, alumno):
        if alumno is not None:
            self.__clear()
            media = self.getAlumnoController().obtener_media_centro(alumno.getDNI(), self.getSesion())
            if  media is not None:
    ...
    def __subMenuMediaGrado(self, grado):
        if grado is not None:
            self.__clear()
            media = self.getGradoController().obtener_media(grado.getCodigo(), self.getSesion())
            if  media is not None:
    ...
    def __subMenuMediaAsignatura(self, asignatura):
        if asignatura is not None:
            self.__clear()
            media = self.getAsignaturaController().obtener_media(asignatura.getCodigo(),self.getSesion())
            if  media is not None:
    ...
    def __subMenuRangosAlumnoCentro(self, alumno):
        if alumno is not None:
            self.__clear()
            rango = self.getAlumnoController().obtener_rango(alumno.getDNI(), self.getSesion())
    ...
    def __subMenuRangosAsignatura(self, asignatura):
        if asignatura is not None:
            self.__clear()
            rango = self.getAsignaturaController().obtener_rango(asignatura.getCodigo(), self.getSesion())
            if rango is not None:
    ...
    def __subMenuRangosGrado(self, grado):
        if grado is not None:
            self.__clear()
            rango = self.getGradoController().obtener_rango(grado.getCodigo(), self.getSesion())
            if rango is not None:
    ...
    def __subMenuMatriculasYMencionesGrado(self, grado):
        if grado is not None:
            self.__clear()
            matriculasYMenciones = self.getGradoController().obtener_matriculas_y_menciones(grado.getCodigo(), self.getSesion())
